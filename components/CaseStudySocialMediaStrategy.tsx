        ...
        {reels.map((reel, i) => (
          <div key={i} className="flex flex-col items-center gap-2">
            ...
            <a
              ...
              className={`text-xs font-semibold text-[#00C3D0] border border-[#00C3D0] rounded-full px-4 py-1.5 min-h-[44px] inline-flex items-center hover:bg-[#00C3D0] hover:text-white transition-colors duration-200 ${FOCUS_RING}`}
            >
              {reel.linkLabel}
            </a>
          </div>
